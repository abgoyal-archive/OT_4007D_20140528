...
#else
#define SP0718_NORMAL_Y0ffset  		0x08
#define SP0718_LOWLIGHT_Y0ffset		0x25
#define  SP0718_normal_P1_0xce       0x0f
#define  SP0718_night_P1_0xce       0x1f
...
void SP0718_NightMode(kal_bool bEnable)
{
	...
	{ 
		...
		SP0718_write_cmos_sensor(0xce,SP0718_night_P1_0xce);
	...
	else    // daylight mode
	{
		...
		SP0718_write_cmos_sensor(0xce,SP0718_normal_P1_0xce);
		if(SP0718_MPEG4_encode_mode == KAL_TRUE)
		{
			if(sp0718_isBanding== 0)
			{
...
void SP0718_Sensor_Init(void)
{
	...
	SP0718_write_cmos_sensor(0xfd,0x00);
	SP0718_write_cmos_sensor(0x1C,0x14);
	SP0718_write_cmos_sensor(0x1f,0x14);
	SP0718_write_cmos_sensor(0x31,0x60);
	SP0718_write_cmos_sensor(0x27,0xb3);
	SP0718_write_cmos_sensor(0x1b,0x1f);
	SP0718_write_cmos_sensor(0x26,0xaa);
	SP0718_write_cmos_sensor(0x37,0x02);
	SP0718_write_cmos_sensor(0x28,0xab);
	SP0718_write_cmos_sensor(0x1a,0x73);
	SP0718_write_cmos_sensor(0x1e,0x1b);
	SP0718_write_cmos_sensor(0x21,0x06);
	SP0718_write_cmos_sensor(0x22,0x38);
	SP0718_write_cmos_sensor(0x0f,0x3f);
	SP0718_write_cmos_sensor(0x10,0x3e);
	SP0718_write_cmos_sensor(0x11,0x00);
	SP0718_write_cmos_sensor(0x12,0x01);
	SP0718_write_cmos_sensor(0x13,0x4f);
	SP0718_write_cmos_sensor(0x14,0x04);
	SP0718_write_cmos_sensor(0x15,0x30);
	SP0718_write_cmos_sensor(0x16,0x50);
	SP0718_write_cmos_sensor(0x17,0x01);
	SP0718_write_cmos_sensor(0x69,0x50);
	SP0718_write_cmos_sensor(0x6a,0xff);
	SP0718_write_cmos_sensor(0x6b,0x33);
	SP0718_write_cmos_sensor(0x6c,0x1a);
	SP0718_write_cmos_sensor(0x6d,0x51);
	SP0718_write_cmos_sensor(0x6e,0xff);
	SP0718_write_cmos_sensor(0x6f,0xff);
	SP0718_write_cmos_sensor(0x70,0x34);
	SP0718_write_cmos_sensor(0x71,0x18);
	SP0718_write_cmos_sensor(0x36,0x00);
	SP0718_write_cmos_sensor(0xfd,0x01);
	...
	SP0718_write_cmos_sensor(0x1f,0x0a);
	SP0718_write_cmos_sensor(0x20,0x00);
	...
	SP0718_write_cmos_sensor(0xa1,0x20);
	SP0718_write_cmos_sensor(0xa2,0x1f);
	SP0718_write_cmos_sensor(0xa3,0x2d);
	SP0718_write_cmos_sensor(0xa4,0x22);
	SP0718_write_cmos_sensor(0xa5,0x1c);
	SP0718_write_cmos_sensor(0xa6,0x1b);
	SP0718_write_cmos_sensor(0xa7,0x23);
	SP0718_write_cmos_sensor(0xa8,0x1b);
	SP0718_write_cmos_sensor(0xa9,0x1c);
	SP0718_write_cmos_sensor(0xaa,0x1a);
	SP0718_write_cmos_sensor(0xab,0x1f);
	SP0718_write_cmos_sensor(0xac,0x1c);
	SP0718_write_cmos_sensor(0xad,0x01);
	SP0718_write_cmos_sensor(0xae,0x05);
	SP0718_write_cmos_sensor(0xaf,0x00);
	SP0718_write_cmos_sensor(0xb0,0x00);
	SP0718_write_cmos_sensor(0xb1,0x02);
	SP0718_write_cmos_sensor(0xb2,0x00);
	SP0718_write_cmos_sensor(0xb3,0x00);
	SP0718_write_cmos_sensor(0xb4,0x00);
	SP0718_write_cmos_sensor(0xb5,0x00);
	SP0718_write_cmos_sensor(0xb6,0x00);
	...
	SP0718_write_cmos_sensor(0xfd,0x01);
	SP0718_write_cmos_sensor(0x32,0x05);//0x15
	SP0718_write_cmos_sensor(0xfd,0x00);
	SP0718_write_cmos_sensor(0xe7,0x03);
	SP0718_write_cmos_sensor(0xfd,0x02);
	SP0718_write_cmos_sensor(0x26,0xb0);
	...
	SP0718_write_cmos_sensor(0x2b,0x00);
	SP0718_write_cmos_sensor(0x28,0xef);
	SP0718_write_cmos_sensor(0x29,0x01);
	...
	SP0718_write_cmos_sensor(0xfd,0x01);
	SP0718_write_cmos_sensor(0x8b,0x00);
	SP0718_write_cmos_sensor(0x8c,0x0b);
	SP0718_write_cmos_sensor(0x8d,0x17);
	SP0718_write_cmos_sensor(0x8e,0x27);
	SP0718_write_cmos_sensor(0x8f,0x35);
	SP0718_write_cmos_sensor(0x90,0x51);
	SP0718_write_cmos_sensor(0x91,0x64);
	SP0718_write_cmos_sensor(0x92,0x74);
	SP0718_write_cmos_sensor(0x93,0x80);
	SP0718_write_cmos_sensor(0x94,0x92);
	SP0718_write_cmos_sensor(0x95,0xa2);
	SP0718_write_cmos_sensor(0x96,0xaf);
	SP0718_write_cmos_sensor(0x97,0xbb);
	SP0718_write_cmos_sensor(0x98,0xc6);
	SP0718_write_cmos_sensor(0x99,0xd0);
	SP0718_write_cmos_sensor(0x9a,0xd9);
	SP0718_write_cmos_sensor(0x9b,0xe0);
	SP0718_write_cmos_sensor(0x9c,0xe8);
	SP0718_write_cmos_sensor(0x9d,0xee);
	SP0718_write_cmos_sensor(0x9e,0xf4);
	SP0718_write_cmos_sensor(0x9f,0xfa);
	SP0718_write_cmos_sensor(0xa0,0xff);
	...
	SP0718_write_cmos_sensor(0xd3,0xa4);
	SP0718_write_cmos_sensor(0xd4,0xa4);
	SP0718_write_cmos_sensor(0xd5,0x88);
	SP0718_write_cmos_sensor(0xd6,0x70);
	          
	SP0718_write_cmos_sensor(0xd7,0xa4);
	SP0718_write_cmos_sensor(0xd8,0xa4);
	SP0718_write_cmos_sensor(0xd9,0x88);
	...
	SP0718_write_cmos_sensor(0x14,0x20);
	SP0718_write_cmos_sensor(0x15,0x20);
	SP0718_write_cmos_sensor(0x16,0x08);
	SP0718_write_cmos_sensor(0x17,0x00);
            
	SP0718_write_cmos_sensor(0xfd,0x01);
	SP0718_write_cmos_sensor(0xcd,SP0718_NORMAL_Y0ffset);
	SP0718_write_cmos_sensor(0xce,SP0718_normal_P1_0xce);
	SP0718_write_cmos_sensor(0xcf,0x20);
	SP0718_write_cmos_sensor(0xd0,0x50);

	SP0718_write_cmos_sensor(0x41,0x00);
	SP0718_write_cmos_sensor(0x42,0x00);
	SP0718_write_cmos_sensor(0x43,0x00);
	SP0718_write_cmos_sensor(0x44,0x00);

	SP0718_write_cmos_sensor(0x56,0x00);
	SP0718_write_cmos_sensor(0x57,0x00);
	SP0718_write_cmos_sensor(0x58,0x00);
	SP0718_write_cmos_sensor(0x59,0x00);


	SP0718_write_cmos_sensor(0xfd,0x01);
	SP0718_write_cmos_sensor(0xfb,0x33);
	//SP0718_write_cmos_sensor(0x32,0x15);
	SP0718_write_cmos_sensor(0x33,0xef);
	SP0718_write_cmos_sensor(0x34,0xe7);
	SP0718_write_cmos_sensor(0x35,0x00);
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->PreviewDelayFrame = 3;//0; kavie
