...
static struct FOTAErrorData fota_error_data[] = {
    ...
    { E_RB_INVALID_FW_OPERATION,              "bad operation number for FW update" },
    ...
    { E_RB_IMAGE_IS_NOT_SOURCE,               "Image verified is not source image" },
