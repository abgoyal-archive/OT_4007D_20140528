...
long RB_CheckDPStructure(unsigned short* pDeltaPath);
long RB_GetNumberOfDeltas(unsigned long* num_deltas, unsigned long *installer_types, unsigned long installer_types_num, UpdateType update_type);
long RB_GetSignedDeltaOffset(unsigned long delta_ordinal, unsigned long* offset, unsigned long* size, unsigned long *installer_types, unsigned long installer_types_num, UpdateType update_type);

long RB_GetDeploymentDataDetails(unsigned long delta_ordinal, CompDeltaType* type, unsigned long* size, unsigned long *installer_types, unsigned long installer_types_num, UpdateType update_type);
long RB_GetDeploymentData(unsigned long delta_ordinal, unsigned char* buffer, unsigned long size, unsigned long *installer_types, unsigned long installer_types_num, UpdateType update_type);

long RB_vRM_ImageUpdate(vRM_DeviceData *pDeviceData);
...
long RB_VerifyLinkReference(void *pbUserData, unsigned short *pLinkName, unsigned short *pReferenceFileName);
long RB_GetFileType(void *pbUserData, const unsigned short *pLinkName, enumFileType *fileType);
...
long RB_CompareFileAttributes(void *pbUserData, unsigned short *pFilePath, unsigned char *pAdditionalAttribs, unsigned long iAddiInfoSize);
